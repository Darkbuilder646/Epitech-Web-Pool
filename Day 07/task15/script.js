...
//* Search word in task
const searchTextForm = document.getElementById("searchTextForm");
const searchText = document.getElementById("searchText");
const resetSearch = document.getElementById("resetSearch");

searchTextForm.addEventListener("submit", (event) => {
    event.preventDefault();
    let searchString = searchText.value.trim().toLowerCase();
